...
<div class="space-y-4">
	<div>
		<h3 class="font-semibold mb-2">Utmaning: Base64-avkodning</h3>
		<p class="text-muted-foreground">Avkoda denna Base64-sträng:</p>
		<pre class="mt-2 p-2 bg-muted rounded">YmFzZTY0X2RlY29kZWQ=</pre>
	</div>
	<div class="space-y-2">
