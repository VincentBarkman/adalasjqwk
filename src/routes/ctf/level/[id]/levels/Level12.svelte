...
<div class="space-y-4">
	<div>
		<h3 class="font-semibold mb-2">Utmaning: Caesar-chiffer</h3>
		<p class="text-muted-foreground">Avkoda detta Caesar-chiffer (shift +3):</p>
		<pre class="mt-2 p-2 bg-muted rounded">fdhvdu_vkliw</pre>
	</div>
	<div class="space-y-2">
