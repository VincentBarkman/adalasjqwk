...
<div class="space-y-4">
	<div>
		<h3 class="font-semibold mb-2">Utmaning: URL-avkodning</h3>
		<p class="text-muted-foreground">Avkoda denna URL-enkodade sträng:</p>
		<pre class="mt-2 p-2 bg-muted rounded">command%5Finjection</pre>
	</div>
	<div class="space-y-2">
